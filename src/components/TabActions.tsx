  ...
  return (
    <>
      <section className="flex flex-row gap-4">
        <button
          className="px-3 py-1.5 rounded-md shadow-md bg-purple-700 text-white hover:bg-purple-800 active:bg-purple-1000 focus:bg-purple-500"
          onClick={() => reloadTabs()}
        >
          <svg
        ...
        >
          <svg
            ...
            className="w-6 h-6"
          >
            <title>Submit Review Form</title>
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <p className="text-center my-2">
        OR submit reviews automagically at once
      </p>
      <button
        className="px-3 py-1.5 rounded-md shadow-md bg-purple-700 text-white hover:bg-purple-800 active:bg-purple-1000 focus:bg-purple-500"
      ...
      >
        <svg
          ...
          className="w-6 h-6"
        >
          <title>Open Review Submit</title>
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
