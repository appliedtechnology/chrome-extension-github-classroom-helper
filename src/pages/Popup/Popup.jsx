...
const Popup = () => {
    ...
    <div className="App">
      ...
      <main className='py-4 px-4 max-h-80 overflow-auto'>
        ...
        <section className="flex items-center justify-center gap-4 flex-col">
          ...
          <button className='px-3 py-1.5 rounded-md shadow-md bg-purple-700 text-white hover:bg-purple-800 active:bg-purple-900 focus:bg-purple-500' onClick={() => reloadTabs()}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><title>Reload Tabs</title>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
          ...
          <button className='px-3 py-1.5 rounded-md shadow-md bg-purple-700 text-white hover:bg-purple-800 active:bg-purple-900 focus:bg-purple-500' onClick={() => approvePRs()}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><title>Approve PRs</title>
